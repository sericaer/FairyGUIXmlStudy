...
namespace FairyGUI
{
	...
	public class UIPackage
	{
		...
		/// <returns></returns>
		public static UIPackage AddPackage(string assetPath, ILoader loader)
		{
			if (_packageInstById.ContainsKey(assetPath))
				return _packageInstById[assetPath];

			var bytes = loader.LoadBytes(assetPath, ".bytes");

			UIPackage pkg = new UIPackage();
			pkg.Create(bytes, null, assetPath, loader, false);
		...
		/// <param name="loadFunc">载入函数</param>
		/// <returns></returns>
		public static UIPackage AddPackage(byte[] descData, string assetNamePrefix, ILoader loader)
		{
			UIPackage pkg = new UIPackage();
